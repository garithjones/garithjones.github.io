angular.module('app').factory('SharedFunctionsGeneric', ['$rootScope', '$resource', '$q', 'SharedFactory', function SharedFunctionsGeneric($rootScope, $resource, $q, SharedFactory) {
    console.log("Shared Functions - Generic");
